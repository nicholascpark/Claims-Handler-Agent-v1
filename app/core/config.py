...
class Settings(BaseSettings):
    ...
    # ===========================================
    app_name: str = Field(default="Kismet Voice Agent", description="Application name")
    ...
    langsmith_project: str = Field(default="kismet-voice-agent", description="LangSmith project name")
